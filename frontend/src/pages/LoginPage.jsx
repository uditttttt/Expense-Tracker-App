...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const loadingToast = toast.loading('Signing in...'); // Show loading toast
        ...
        try {
            ...
            toast.success('Login successful!', { id: loadingToast }); // Show success toast
            navigate('/');
        } catch (error) {
            console.error('Login failed:', error.response?.data);
            const message = error.response?.data?.message || 'Login failed. Please check your credentials.';
            toast.error(message, { id: loadingToast }); // Show error toast
        } finally {
